...
I reccomend using swagger when you are trying the steps below for the first time since you don't have to worry about about knowing what is required and not.  There is a section on using swagger with this service below.
...
###Example
The following example uses data taken from [http://www.dallasguns.com](http://www.dallasguns.com)
